    ...
    <footer className="footer footer-horizontal bg-base-300 text-neutral-content text-base-content/50 items-center p-2">
      <aside>
        <span className="text-base-content/50">
          ...
          >
            <FontAwesomeIcon icon={faGithub} className="text-lg relative top-[2px]" />
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <FontAwesomeIcon icon={faGlobe} className="text-lg relative top-[2px]" />
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <FontAwesomeIcon icon={faDiscord} className="text-lg relative top-[2px] ms-1" />
          </a>
        </span>
      </aside>
